					...
					<div class="card">
								...
								<div class="row">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" name="product_price" value="{{old ('product_price') ??   $product->product_price }}">
													@error('product_price')
										    			<div class="has-error" style="padding-left: 10px; background-color: red; border-radius: 5px;">{{ $message }}</div>
													@enderror
												</div>
												...
												<div class="form-group">
													...
													<input type="file" class="form-control" id="image" name="image" value="{{ $product->product_image }}">
													@error('image')
										    			<div class="has-error" style="padding-left: 10px; background-color: red; border-radius: 5px;">{{ $message }}</div>
													@enderror
												</div>
											...
											<div class="col-md-6">													
												...
												<div class="form-group">
													...
													<textarea class="form-control" id="product_details" cols="30" rows="16" name="product_details">{{  $product->product_details }}</textarea>  
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio" name="product_status" id="product_status" value="1" @if( $product->product_status == 1) checked  @endif>
															<label class="form-check-label">
															Active
															</label>
														</div>
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio" name="product_status"  value="0" @if( $product->product_status == 0) checked  @endif>
															<label class="form-check-label">
															Deactive
															</label>
														</div>
						...
						<!-- Feature Product Div Start -->
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio" name="featured_product"  value="1" id="featured_product"  @if(  $product->featured_product == 1) checked  @endif>
															<label class="form-check-label" >
															Yes
															</label>
														</div>
														<div class="form-check form-check-inline">
															<input class="form-check-input" type="radio" name="featured_product"  value= "0" @if( $product->featured_product == 0) checked  @endif>
															<label class="form-check-label">
															No
															</label>
															</div>
